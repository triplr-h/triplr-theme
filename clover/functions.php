...
function themeConfig($form) {
	$title = new Typecho_Widget_Helper_Form_Element_Text('clover_title', NULL,  "triplr", _t('站点标题'), _t('在这里填入想显示的站点标题，要求必须为英文'));
	$form->addInput($title);

	$subtitle = new Typecho_Widget_Helper_Form_Element_Text('clover_subtitle', NULL,  "Life, Love, Freedom", _t('站点副标题'), _t('在这里填入想显示的站点副标题，要求必须为英文'));
	$form->addInput($subtitle);

	$contents = new Typecho_Widget_Helper_Form_Element_Textarea('clover_contents', NULL,  "<a href=\"index.php/category/life/\">Life</a> | <a href=\"index.php/category/sjtu/\">SJTU</a> | <a href=\"index.php/category/blog/\">Blog</a> | <a href=\"/love/index.html\">Love</a> | <a href=\"about.html\">About</a> ", _t('站点主页内容HTML'), _t('在这里填入站点主页内容的HTML'));
	...
	$start_time = new Typecho_Widget_Helper_Form_Element_Text('clover_start_time', NULL,  '2020/2/20 12:31:15', _t('博客运行时间'), _t('格式务必为 YY/MM/DD HH:MM:SS'));
	$form->addInput($start_time);

	$leave = new Typecho_Widget_Helper_Form_Element_Text('clover_leave', NULL,  '|ω･) 猜猜我在哪~', _t('离开时标题'), _t('用户离开该网站时的网站暂时标题'));
	$form->addInput($leave);

	$return = new Typecho_Widget_Helper_Form_Element_Text('clover_return', NULL,  '(/≧▽≦)/ 欢迎欢迎！', _t('返回时标题'), _t('用户返回该网站时的网站暂时标题'));
